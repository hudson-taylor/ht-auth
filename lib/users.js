...
module.exports = function(transport, db, options, log) {
  ...
  service.on("enableMFA", s.Object({
    id:   s.String({ opt: false }),
    type: s.String({ opt: false, enum: [ "totp", "google", "yubikey" ] }),
    data: s.Object({ opt: true,  strict: false })
  }), function(request, callback) {
    ...
    findUser(request.id, function(err, user) {
      ...
      switch(request.type) {
        ...
        case "totp":
        case "google": {
          enableTOTP(user, request.data, callback);
          break;
        }

        case "yubikey": {
          enableYubikey(user, request.data, callback);
          break;
        }
  ...
  service.on("confirmMFA", s.Object({
    id:   s.String({ opt: false                             }),
    type: s.String({ opt: false, enum: [ "totp", "google", "yubikey" ] }),
    data: s.Object({ opt: true,  strict: false              })
  }), function(request, callback) {
    ...
    findUser(request.id, function(err, user) {
      ...
      switch(request.type) {
        ...
        case "totp":
        case "google": {
          confirmTOTP(user, request.data, callback);
          break;
        }

        case "yubikey": {
          confirmYubikey(user, request.data, callback);
          break;
        }
  ...
  function enableTOTP(user, data, callback) {
  ...
  function confirmTOTP(user, data, callback) {
  ...
  function enableYubikey(user, data, callback) {
  ...
  function confirmYubikey(user, data, callback) {
